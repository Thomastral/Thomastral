...
void dessiner_tableau()
{
    ...
    cout << "\n\n\t\e[37;1m   Tic Tac Toe\e[0m\n\n";
    cout << "\e[37mJoueur 1 (\e[0m\e[31;1mX\e[0m\e[37m) - Joueur 2 (\e[0m\e[32;1mO\e[0m\e[37m)\e[0m" << endl << endl;
    cout << "\t\e[37;1m     |     |     \e[0m" << endl;
    cout << "\t  ";

    // Affichage de la première case du tableau
    if (tableau[0][0] == 'X')
        cout << "\e[1;31m" << tableau[0][0] << "\e[0m";
    else if (tableau[0][0] == 'O')
        cout << "\e[1;32m" << tableau[0][0] << "\e[0m";
    else
        cout << "\e[37m" << tableau[0][0] << "\e[0m";

    cout << "\e[37;1m  |  \e[0m";

    // Affichage de la deuxième case du tableau
    if (tableau[0][1] == 'X')
        cout << "\e[1;31m" << tableau[0][1] << "\e[0m";
    else if (tableau[0][1] == 'O')
        cout << "\e[1;32m" << tableau[0][1] << "\e[0m";
    else
        cout << "\e[37m" << tableau[0][1] << "\e[0m";

    cout << "\e[37;1m  |  \e[0m";

    // Affichage de la troisième case du tableau
    if (tableau[0][2] == 'X')
        cout << "\e[1;31m" << tableau[0][2] << "\e[0m";
    else if (tableau[0][2] == 'O')
        cout << "\e[1;32m" << tableau[0][2] << "\e[0m";
    else
        cout << "\e[37m" << tableau[0][2] << "\e[0m";

    cout << endl;
    cout << "\t\e[37;1m_____|_____|_____\e[0m" << endl;
    cout << "\t\e[37;1m     |     |     \e[0m" << endl;
    ...
    // Affichage de la première case du tableau
    if (tableau[1][0] == 'X')
        cout << "\e[1;31m" << tableau[1][0] << "\e[0m";
    else if (tableau[1][0] == 'O')
        cout << "\e[1;32m" << tableau[1][0] << "\e[0m";
    else
        cout << "\e[37m" << tableau[1][0] << "\e[0m";

    cout << "\e[37;1m  |  \e[0m";

    // Affichage de la deuxième case du tableau
    if (tableau[1][1] == 'X')
        cout << "\e[1;31m" << tableau[1][1] << "\e[0m";
    else if (tableau[1][1] == 'O')
        cout << "\e[1;32m" << tableau[1][1] << "\e[0m";
    else
        cout << "\e[37m" << tableau[1][1] << "\e[0m";

    cout << "\e[37;1m  |  \e[0m";

    // Affichage de la troisième case du tableau
    if (tableau[1][2] == 'X')
        cout << "\e[1;31m" << tableau[1][2] << "\e[0m";
    else if (tableau[1][2] == 'O')
        cout << "\e[1;32m" << tableau[1][2] << "\e[0m";
    else
        cout << "\e[37m" << tableau[1][2] << "\e[0m";
    ...
    // Affichage de la première case du tableau
    if (tableau[2][0] == 'X')
        cout << "\e[1;31m" << tableau[2][0] << "\e[0m";
    else if (tableau[2][0] == 'O')
        cout << "\e[1;32m" << tableau[2][0] << "\e[0m";
    else
        cout << "\e[37m" << tableau[2][0] << "\e[0m";

    cout << "\e[37;1m  |  \e[0m";

    // Affichage de la deuxième case du tableau
    if (tableau[2][1] == 'X')
        cout << "\e[1;31m" << tableau[2][1] << "\e[0m";
    else if (tableau[2][1] == 'O')
        cout << "\e[1;32m" << tableau[2][1] << "\e[0m";
    else
        cout << "\e[37m" << tableau[2][1] << "\e[0m";

    cout << "\e[37;1m  |  \e[0m";

    // Affichage de la troisième case du tableau
    if (tableau[2][2] == 'X')
        cout << "\e[1;31m" << tableau[2][2] << "\e[0m" << endl;
    else if (tableau[2][2] == 'O')
        cout << "\e[1;32m" << tableau[2][2] << "\e[0m" << endl;
    else
        cout << "\e[37m" << tableau[2][2] << "\e[0m" << endl;

    cout << "\t\e[37;1m     |     |     \e[0m" << endl << endl;
}
...
void tour_de_jeu()
{
    ...
    cout << "\e[37mC'est le tour du joueur \e[37;1m" << joueur << "\e[0m\e[37m. \n\nEntrez un nombre pour choisir votre case : \e[0m";
    cin >> choix;
    printf("\n");
...
void jouer()
{
    while (!partie_terminee)
    {
        ...
        {
            dessiner_tableau();
            cout << "\e[37mLe joueur \e[37;1m" << joueur << "\e[0m\e[37m a perdu !\e[0m\n";
    ...
    char choix;
    cout << "\n\e[37;6;3mVoulez-vous rejouer ? (1 pour oui, 0 pour non) : \e[0m";
    cin >> choix;
